...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """userData/""" + "$" + """userName<[^/]+>""", """controllers.UserDataController.getUserData(request:Request, userName:String)"""),
  ...
  private[this] lazy val controllers_UserDataController_getUserData3_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      UserDataController_3.getUserData(fakeValue[play.mvc.Http.Request], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_UserDataController_getUserData3_route(params@_) =>
      call(params.fromPath[String]("userName", None)) { (userName) =>
        controllers_UserDataController_getUserData3_invoker.call(
          req => UserDataController_3.getUserData(req, userName))
      }
