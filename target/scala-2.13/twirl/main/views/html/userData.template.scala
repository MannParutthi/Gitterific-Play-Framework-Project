					...
					<h4>Url : """),_display_(/*37.17*/data/*37.21*/.getUrl()),format.raw/*37.30*/("""</h4>
  					    		...
  					    		"""),_display_(/*39.15*/for(repo <- data.getRepoName()) yield /*39.46*/ {_display_(Seq[Any](format.raw/*39.48*/("""
  					    			"""),format.raw/*40.15*/("""<ol type="A">
  					    				<li>				    					
  					    						<li><h4>Repo Name : <a href='"""),_display_(/*42.48*/routes/*42.54*/.HomeController.getRepoData(data.getLogin(), repo)),format.raw/*42.104*/("""'>"""),_display_(/*42.107*/repo),format.raw/*42.111*/("""</a></h4></li>
  					    				</li>
  					    			</ol>
  					    		""")))}),format.raw/*45.15*/("""
 				"""),format.raw/*46.6*/("""</div>
